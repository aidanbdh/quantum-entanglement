...
module.exports = {
  ...
  toggle: function() {
    ...
    const connect = require('./connect')(this.subscriptions, atom.workspace.getActiveTextEditor(), this.connected)
    ...
    document.getElementById('server-form').addEventListener('submit', function(event) {
      ...
      document.getElementById('user-form').addEventListener('submit', function(event) {
        ...
        connect({ input, username }, conflict, notification, 'https://quantum-entanglement.herokuapp.com/')
        user.hide()
      })
    })
    alert.show()
